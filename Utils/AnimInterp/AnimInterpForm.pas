...
uses
  ShellApi,
  KM_Pics, KM_ResHouses, KM_ResUnits, KM_ResSprites, KM_Points, KM_ResSpritesEdit, KM_Defaults, KM_Log, KM_CommonTypes;
...
begin
  ...
  try
      ...
      DainParams := '/C "'+DainExe+'" --cli 1 -o '+TempDir+' -p 0 -l 1 -in 8 -da 0 -a 1 -se 0 -si 1 -sr 0 -ha 0 --fast_mode 0 & pause';
