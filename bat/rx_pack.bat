...
call ..\Utils\RXXPacker\RXXPacker.exe srx "%KMRResourcesRepoDir%"\SpriteResource\ sint "%KMRResourcesRepoDir%"\SpriteInterp\Output\ d "%kam_folder%"\data\Sprites\ rxa all
if errorlevel 1 goto exit3
