...
begin
  ...
  begin
    Button_BlockHouse[I] := TKMButtonFlat.Create(Panel_BlockHouse, 9 + ((I-1) mod 5)*37, 30 + ((I-1) div 5)*37,33,33,gResHouses[GUIHouseOrder[I]].GUIIcon);
    Button_BlockHouse[I].Hint := gResHouses[GUIHouseOrder[I]].HouseName;
