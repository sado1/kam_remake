...
begin
  ...
  ResetDragObject;
  //                                   250
  TKMImage.Create(Panel_Main, 0,    0, MAPED_TOOLBAR_WIDTH, 200, 407, rxGui, pl0, [anLeft, anTop, anRight]); //Minimap place
  TKMImage.Create(Panel_Main, 0,  200, MAPED_TOOLBAR_WIDTH, 400, 404, rxGui, pl0, [anLeft, anTop, anRight]);
  TKMImage.Create(Panel_Main, 0,  600, MAPED_TOOLBAR_WIDTH, 400, 404, rxGui, pl0, [anLeft, anTop, anRight]);
  TKMImage.Create(Panel_Main, 0, 1000, MAPED_TOOLBAR_WIDTH, 400, 404, rxGui, pl0, [anLeft, anTop, anRight]); //For 1600x1200 this is needed
  TKMImage.Create(Panel_Main, 0, 1400, MAPED_TOOLBAR_WIDTH, 400, 404, rxGui, pl0, [anLeft, anTop, anRight]);
  TKMImage.Create(Panel_Main, 0, 1800, MAPED_TOOLBAR_WIDTH, 400, 404, rxGui, pl0, [anLeft, anTop, anRight]); //For 4K displays
